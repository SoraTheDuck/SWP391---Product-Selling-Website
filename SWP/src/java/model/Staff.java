...
public class Staff {
    ...
    public void editStaff(int id, String name, String password, String phone) {
        try {
            String strUpdate = "update headphone.staff set StaffName=?, Password=?, Phone=? where StaffID=?";
            pstm = cnn.prepareStatement(strUpdate);
            ...
            System.out.println("editStaff: " + ex.getMessage());
        }
