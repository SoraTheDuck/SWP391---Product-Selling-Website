...
public class Product {
    ...
    public Product(String id, String name, float price, String image, int quantity, String wire, String description, int categoryId, String releaseDate) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.image = image;
    ...
    public Product(String id, String name, float price, String image, int quantity, String wire, String description, int categoryId, String releaseDate, int discount, float saleprice, float avgrating, String startdate, String enddate) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.image = image;
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getDate(9) != null) {
                    Rdate = f.format(rs.getDate(9));
                }

                list.add(new Product(Tid, Tname, Tprice, Timage, Tquantity, Twire, Tdescription, Cid, Rdate));
            }
        } catch (Exception ex) {
