                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="category-menu">
                            ...
                            <div id="cate-toggle"
                                ...
                                <ul>
                                    <li class="right-menu"><a href="shop-left-sidebar.jsp">Laptops</a>
                                        <ul class="cat-mega-menu">
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Prime Video</a>
                                                <ul>
                                            ...
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Computers</a>
                                                <ul>
                                            ...
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Electronics</a>
                                                <ul>
                                    ...
                                    <li class="right-menu"><a href="shop-left-sidebar.jsp">TV & Audio</a>
                                        <ul class="cat-mega-menu">
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Chamcham</a>
                                                <ul>
                                            ...
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Meito</a>
                                                <ul>
                                            ...
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Sony Bravia</a>
                                                <ul>
                                    ...
                                    <li class="right-menu"><a href="shop-left-sidebar.jsp">Smartphone</a>
                                        <ul class="cat-mega-menu cat-mega-menu-2">
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">Camera Accessories</a>
                                                <ul>
                                            ...
                                            <li class="right-menu cat-mega-title">
                                                <a href="shop-left-sidebar.jsp">XailStation</a>
                                                <ul>
                                ...
                                <div class="single-slide align-center-left animation-style-02 bg-4">
                                    ...
                                    <div class="slider-content">
                                        ...
                                        <div class="default-btn slide-btn">
                                            <a class="links"
                                               href="shop-left-sidebar.jsp">Shopping Now</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="li-section-title">
                            ...
                            <ul class="li-sub-category-list">
                                <li class="active"><a href="shop-left-sidebar.jsp">Prime Video</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="li-section-title">
                            ...
                            <ul class="li-sub-category-list">
                                ...
                                <li><a href="shop-left-sidebar.jsp">Sony Bravia</a></li>
                            </ul>
                        </div>
                        <div class="li-banner-2 pt-15">
                            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="li-section-title">
                            ...
                            <ul class="li-sub-category-list">
                                <li class="active"><a href="shop-left-sidebar.jsp">Camera Accessories</a></li>
                                <li><a href="shop-left-sidebar.jsp">XailStation</a></li>
                            </ul>
                        </div>
                        <div class="li-banner-2 pt-15">
                            <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="li-product-tab li-trending-product-tab">
                            ...
                            <ul class="nav li-product-menu li-trending-product-menu">
                                <li><a class="active"
                                       data-toggle="tab"
                                       href="#home1"><span>Meito</span></a></li>
                                <li><a data-toggle="tab"
                                       href="#home2"><span>Camera Accessories</span></a></li>
                                <li><a data-toggle="tab"
                                       href="#home3"><span>XailStation</span></a></li>
                            </ul>
                        </div>
