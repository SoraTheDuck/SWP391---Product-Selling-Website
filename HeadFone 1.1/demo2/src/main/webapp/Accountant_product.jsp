<%--
    Document   : Accountant_product
    Created on : Jul 20, 2023, 1:13:52 AM
    Author     : Acer Aspire
--%>
    ...
    <div class="section__content section__content--p30">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <!-- DATA TABLE -->
            <h3 class="title-5 m-b-35">Revenues</h3>
                ...
                <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                  ...
                  <form id="frm2" action="exportorder" method="post">
                    <select class="js-select2" name="type" onchange="change2()">
                      ...
                      <option value="2">Export All to csv file</option>
                    </select>
