<%-- 
    ...
    Created on : Jul 21, 2023, 8:56:13 PM
    Author     : Acer Aspire
--%>
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                            ...
                                            <form id="frm2" action="exportordermanager" method="post">
                                                <select class="js-select2" name="type" onchange="change3()">
                                        ...
                                        <tbody>
                                            <c:forEach var="o" items="${orderAList}" >
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>${o.getStaffid()}</td>
                                                    <c:choose>
                                                        <c:when test="${o.getOstatus() == 1}">
                                                            <td style="color: green">Completed</td>
                                                        </c:when>
                                                        <c:when test="${o.getOstatus() == 0}">
                                                            <td style="color: red">Rejected</td>
                                                        </c:when>
                                                        <c:when test="${o.getOstatus() == 3}">
                                                            <td style="color: #d39e00">In-Progress</td>
                                                        </c:when>
                                                    </c:choose>
                                                    <td>${o.getCdate()}</td>
