                                        ...
                                        <tbody>
                                            <c:forEach var="o" items="${sessionScope.cart.items}">
                                                <tr>
                                                    ...
                                                    <td class="li-product-thumbnail"><a href="detail?pid=${o.product.id}"><img width="40%" height="40%" src="data:image/jpg;charset=utf8;base64,${o.product.image}" alt="Li's Product Image"></a></td>
                                                    <td class="li-product-name"><a href="#">${o.product.name}</a></td>
                                                    <td class="li-product-price">
                                                        <span class="amount">$ $<fmt:formatNumber pattern="##.#" value="${o.price}"/></span></td>
                                                    <td class="quantity">
