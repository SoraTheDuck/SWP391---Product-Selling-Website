...
<html>
    <head>
        ...
        <style>
            ...
            .table-data2 .action-cell .table-data-feature {
                display: flex;
                                ...
                                <table class="table table-data2">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>email</th>
                                            <th>address</th>
                                            <th stype="align: center;">action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="action-cell">
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit" onclick="window.location.href = 'edit-cus?cId=${ls.id}'">
