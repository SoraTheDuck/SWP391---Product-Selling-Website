                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box pt-xs-20 pb-xs-15">
                                                    <c:if test="${currentPage != 1}">
                                                        <li><a href="<c:url value="/shop" ><c:param name="page" value="${currentPage - 1}" /></c:url>" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a></li>
                                                        </c:if>
                                                        <c:forEach begin="1" end="${totalPage}" var="i">
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                <li><a href="<c:url value="/shop" ><c:param name="page" value="${i}" /></c:url>"><c:out value="${i}" /></a></li>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:forEach>
                                                        <c:if test="${currentPage != totalPage}">
                                                        <li><a href="<c:url value="/shop" ><c:param name="page" value="${currentPage + 1}" /></c:url>" class="Next"> Next <i class="fa fa-chevron-right"></i></a></li>
                                                            </c:if>
                                                </ul>
                                            </div>
                                        </div>
