        ...
        <div class="body-wrapper">
            ...
            <div class="container mt-10 mb-100">
                <div class="login-form"  style="margin-top: 60px; border-radius:5px">
                    ...
                    <p>2. Our system will send you an OTP code to your email</p>
                    <p>3. Enter the code on the next page</p>
                    <p>4. If the code is verified successfully, it will become your new password (you can change it later)</p>
                    <div>
                        <p style="color: red">${fmess}</p>
                        <form action="forgotpassword" method="post">
                            <input name="femail" type="email" placeholder="Enter your registered email address" required>
                            <button class="register-button mt-0" type="submit">Get Code</button>
                        </form>
                    </div>
