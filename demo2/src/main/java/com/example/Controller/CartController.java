...
public class CartController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("Para: " + scrollPos);
        ...
        if(redirect.equals("search")) resp.sendRedirect(redirect);

        if(redirect.equals("display")){
            var opSession = session.getAttribute("opSession");
            resp.sendRedirect(redirect + "?tag=" + opSession);
        }

        if(redirect.equals("category"))
        {
            String cid=req.getParameter("cid");
            resp.sendRedirect("category?cid="+cid);
        }
    }
