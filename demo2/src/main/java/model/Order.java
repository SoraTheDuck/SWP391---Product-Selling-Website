...
public class Order {
    ...
    public List<Order> getListNotCompletedOrder(int staffID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new Order(rs.getInt(1), date, rs.getFloat(3), rs.getInt(4), rs.getInt(5), rs.getString(7), rs.getString(6)));
            }
        } catch (Exception e) {
    ...
    public Order(int id, String date, float totalmoney, int customerid, int staffid,String cphone, String daddress) {
        this.id = id;
        this.date = date;
        this.totalmoney = totalmoney;
        this.customerid = customerid;
